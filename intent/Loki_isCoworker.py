...
def debugInfo(inputSTR, utterance):
    if DEBUG_isCoworker:
        print("[isCoworker] {} ===> {}".format(inputSTR, utterance))
...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "僅為[同事]關係":
        # write your code here
        pass

    if utterance == "僅為普通之[工作][同事]關係":
        # write your code here
        pass

    if utterance == "原為[同事]關係":
        # write your code here
        pass
